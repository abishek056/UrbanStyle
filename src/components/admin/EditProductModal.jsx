...
import { X, Save, Package, Tag, DollarSign, List, Image } from 'lucide-react';
    ...
    return (
        <AnimatePresence>
            <div className="modal-overlay" onClick={onClose}>
                <motion.div
                    className="admin-modal edit-product-modal"
                ...
                >
                    <div className="modal-header">
                        <div className="header-title">
                            ...
                            <div>
                                ...
                                <p>Update product information for <strong>{product.name}</strong></p>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="modal-content">
                        <div className="form-grid">
                            ...
                            <div className="form-group">
                                <label><Package size={14} /> Stock Level</label>
                                <input
                                    type="number"
                                    required
